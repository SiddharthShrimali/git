		     ...
		     const char *filter_spec)
{
	 ...
	 * querying the remotes (via the object-info capability), which has no
	 * client-side implementation yet. When that is merged into the codebase,
	 * this should record the exact remote that has each dropped object.
	 */
